...
int main()
{
	...
	// Element buffer object is used to draw sth via idices. IT ALWASY HAVE TO BY BIND FIRST BEFORE USE GL BUFFER DATA FUNCTION LIKE ANY ANOTHER BUFFER
	unsigned int EBO;
	glGenBuffers(1, &EBO);
	...
	while (!glfwWindowShouldClose(window)) // main loop
	{
		...
		glUseProgram(shaderProgram);
		glBindVertexArray(VAO);
		glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0); // Use this indstead of glDrawArrays second argument total cound of vertices with we will see, third type of array with indices
